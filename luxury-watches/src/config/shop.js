export const shop = {
  ...
  subtagline: 'Precision crafted for every moment.',
  ctaText: 'Explore the Collection',
  scrollText: 'SCROLL TO DISCOVER',
  year: 2018,
  description: `Since 2018, Chronohaushas helped customers discover watches that become part of their story. Our curated collection spans heritage brands and modern masterpieces — each chosen for its craftsmanship, character, and lasting value.`,
  story: [
  ...
  social: {
    instagram: 'https://instagram.com/chronohaus',
    facebook: 'https://facebook.com/chronohaus',
  },
  brands: [
    'Rolex', 'Omega', 'TAG Heuer', 'Longines', 'Tissot',
